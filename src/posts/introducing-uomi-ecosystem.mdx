export const metadata = {
    ...
    image: "/assets-blog/uomi-ecosystem.jpg"
};
...
- **Staking**: UOMI tokens can be wrapped into veUOMI (voting escrowed UOMI) tokens to stake and participate in securing the network without running a node. 25% of issuance is reserved to stakers.
...
- **AI Agents owners**: AI Agents are entitled to an Universal Basic Compute (UBC) issuance. There will be only 1024 AI agents with access to UBC, 5% of UOMI issuance will be directed to AI Agents, owning an AI Agent will enable access to this supply. 
- **Governance**: by wrapping UOMI tokens in veUOMI, token holders can participate in UOMI Network governance decisions.